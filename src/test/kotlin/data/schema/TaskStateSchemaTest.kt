...
class TaskStateSchemaTest {
    ...
    private companion object {
        //region Some States
        val validState = TaskStateDto(
            id = "s1", name = "n1", projectId = "p1"
        )
        val invalidStateEmptyId = TaskStateDto(
            id = "", name = "n1", projectId = "p1"
        )
        val invalidStateEmptyName = TaskStateDto(
            id = "s1", name = "", projectId = "p1"
        )
        val invalidStateEmptyProjectId = TaskStateDto(
            id = "s1", name = "n1", projectId = ""
        )
